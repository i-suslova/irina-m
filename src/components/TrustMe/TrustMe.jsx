...
const TrustMe = () => {
    return (
        ...
        <section className='trust-me' id='trust-me'>

            <div className='trust-me__container'>
                <img
                    className='trust-me__img'
                    src={TrustMePhoto}
                    alt='Фотография коуча'
                />
                <div>
                    <h2 className='trust-me__title'>Почему мне доверяют</h2>
                    <div className='trust-me__line'></div>
                    <div className='trust-me__wrapper'>
                        <div className='trust-me__block'>
                            <p className='trust-me__number'>1.</p>
                            <p className='trust-me__text'> В качестве сертифицированного Коуча
                        ...
                        <div className='trust-me__block'>
                            <p className='trust-me__number'>2.</p>
                            <p className='trust-me__text'> В качестве Психолога
