...
const App = () => {
  ...
  return (
    <div className={`app ${isDarkMode ? "dark-theme" : "light-theme"}`}>
      ...
      <Routes>
        <Route path="/" element={<Main themeClass={themeClass} />} />
        ...
        <Route
          path="/whatsapp"
          element={<WhatsAppLink themeClass={themeClass} />}
        />
        <Route
          path="/telegram"
          element={<TelegramLink themeClass={themeClass} />}
        />
        <Route
          path="/privacy-policy"
          element={<PrivacyPolicy themeClass={themeClass} />}
        />
